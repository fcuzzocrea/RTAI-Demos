...
#define DEFAULT_PERIOD 100000LL
...
void latency(void *cookie)
{
	...
	fault_threshold = rt_timer_ns2tsc(DEFAULT_PERIOD);
...
static const char *reason_str[] = {
	...
	[SIGDEBUG_NOMLOCK] = "XRTAI: process memory not locked "
	"(missing mlockall?)",
	[SIGDEBUG_WATCHDOG] = "RTAI: watchdog triggered "
	"(period too short?)",
};
